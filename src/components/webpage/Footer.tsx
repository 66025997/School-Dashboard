...
const Webpage: React.FC<Props> = () => {
  return (
    <div className="bg-gray-100">
      ...
      <header className="bg-white shadow">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <img src="logo-placeholder.png" alt="School Dashboard Logo" className="h-12" />
      ...
      <section className="relative bg-cover bg-center h-[500px]" style={{ backgroundImage: "url('public/page.png/hero-placeholder.jpg')" }}>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            <img src="public/page.png/Support.jpg" alt="Support" className="mx-auto mb-4 rounded-md shadow-md" />
